...
2. Exponential (or power) model (`expv`); homogeneous variance form.
3. Exponential (or power) model (`exph`); heterogeneous variance form.
4. Autoregressive model of order 1 (`ar1v`); homogeneous variance form.
5. Autoregressive model of order 1 (`ar1h`); heterogeneous variance form.
6. Antedependence variance model of order 1 (`ante`).
7. Unstructured variance model (`us`).
